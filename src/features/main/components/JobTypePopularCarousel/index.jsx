...
function JobTypePopularCarousel() {
  const settings = {
    dots: true,
    infinite: false,
    arrows: true,
  ...
  return (
    <div className="popular py-12 px-8">
      ...
      <Carousel {...settings}>
        <div>
          <div className={`${Style.item}`}>
            <Link to="/" className="flex justify-start space-x-3 items-center">
              <img
                className="w-12 h-12"
        ...
        <div>
          <div className={`w-fit ${Style.item}`}>
            <Link to="/" className="flex justify-start space-x-3 items-center">
              <img
                className="w-12 h-12"
          ...
          <div className={`w-fit ${Style.item}`}>
            <Link to="/" className="flex justify-start space-x-3 items-center">
              <img
                ...
                alt="error"
              ></img>
              <span className="text-base font-semibold">Image Editing</span>
              <svg
                width={16}
                height={16}
                viewBox="0 0 16 16"
          ...
          <div className={`w-fit ${Style.item}`}>
            <Link to="/" className="flex justify-start space-x-3 items-center">
              <img
                ...
                alt="error"
              ></img>
              <span className="text-base font-semibold">NFT Art</span>
              <svg
                width={16}
                height={16}
                viewBox="0 0 16 16"
          ...
          <div className={` ${Style.item}`}>
            <Link to="/" className="flex justify-start space-x-3 items-center">
              <img
                ...
                alt="error"
              ></img>
              <span className="text-base font-semibold">Illustration</span>
              <svg
                width={16}
                height={16}
                viewBox="0 0 16 16"
        ...
        <div>
          <div className={` ${Style.item}`}>
            <Link to="/" className="flex justify-start space-x-3 items-center">
              <img
                className="w-12 h-12"
                src="https://fiverr-res.cloudinary.com/image/upload/f_auto,q_auto/v1/attachments/generic_asset/asset/e72f248973b8a6b99a5786e63b6a3b1c-1630333285646/Resume%20Writing.png"
                alt="error"
              ></img>
              <span className="text-base font-semibold">
        ...
        <div>
          <div className={` ${Style.item}`}>
            <Link to="/" className="flex justify-start space-x-3 items-center">
              <img
                className="w-12 h-12"
                src="https://fiverr-res.cloudinary.com/image/upload/f_auto,q_auto/v1/attachments/generic_asset/asset/97477f04af40de3aa1f8d6aa21f69725-1626179101632/Graphics%20for%20Streamers_2x.png"
                alt="error"
              ></img>
              <span className="text-base font-semibold">
...
export default JobTypePopularCarousel;
